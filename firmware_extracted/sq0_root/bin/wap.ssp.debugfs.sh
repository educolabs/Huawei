...
insmod $sdk_pwd/hi_eth.ko
insmod $sdk_pwd/hi_dp.ko
insmod $sdk_pwd/hi_ioctl_dp.ko
insmod $sdk_pwd/hi_mdio.ko
insmod $sdk_pwd/hi_gpio.ko
insmod $sdk_pwd/hi_gpio_int.ko
insmod $sdk_pwd/hi_i2c.ko
insmod $sdk_pwd/hi_timer.ko
insmod $sdk_pwd/hi_spi.ko
insmod $sdk_pwd/hi_sysctl.ko
insmod $sdk_pwd/hi_uart.ko
insmod $sdk_pwd/hi_dma.ko
insmod $sdk_pwd/hi_hw.ko  
insmod $sdk_pwd/hi_ext_int.ko  
insmod $sdk_pwd/hi_ioctl_sysctl.ko
