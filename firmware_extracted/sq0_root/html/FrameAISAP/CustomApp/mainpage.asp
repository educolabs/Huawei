...
function SetDeviceNum()
{
    ...
    document.getElementById("loadingplay").style.display="none";
...
function loadframe()
{
	...
	<!-- �жϵ�ǰģʽ����ѡ����Ӧ��radiobox�ؼ� ͬʱ�л�����ͼ������RTģʽ�µ��¹��豸ͼ��Ϊ��������ɫ��,-->
	if(("" != curChangeMode && 0 != curChangeMode) || apghnfeature == 1)
	{
        ...
        } else if (curChangeMode == '4' && adaptResult == '1') {
...
function DivYXfun(id)
{
    if (id == "reyouxian1") {
        document.getElementById("loadingplay").style.display="block";
    }
...
<div id="loadingplay" style="width:100%;display: none;">
    <img style="width:120px;height:120px;position:absolute;top: 45%;left: 36%;" src="../images/loading.gif"/>
</div>

<!-- ������ģʽ����ͼ Access Point -->

<!-- �м���ģʽ����ͼ Range Extender -->
<div id="newRangeExtender" style="display:none;">
	<div id="reInterPics">
		...
		<div id="redevices">
		<div id="rewuxiandev">
			<div id="rewuxian1" class="rewuxian1" onClick="DivWXfun(this.id);" onmouseover="this.className='rewuxian2'" onmouseout="this.className='rewuxian1'"></div>
			<div id="rewxdev" style="" BindText="mainpage037"></div>
		</div>
		<div id="reyouxiandev">
			<div id="reyouxian1" class="reyouxian1" onClick="DivYXfun(this.id);" onmouseover="this.className='reyouxian2'" onmouseout="this.className='reyouxian1'"></div>
