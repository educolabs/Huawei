...
<link href="Cuscss/<%HW_WEB_GetCusSource(preindex.css);%>" rel="stylesheet" type="text/css" />
...
<script language="JavaScript" src="preframe.asp"></script>
<title></title>
</head>
<body> 
<div id="main"> 
	...
	<div id="center">
		<div id="nav" class="others"></div>
		<div id="content"> 
			<div id="topNav"> <span class="topNavMainMenu"></span></div> 
