...
{
	document.write("Conexión de red interrumpida. Verifique la conexión upstream o comuníquese con el proveedor de servicios de internet para resolver el problema.");
}
</script>	
</p>
 </body>
