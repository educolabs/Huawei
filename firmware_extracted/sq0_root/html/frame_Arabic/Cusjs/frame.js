		...
		if(type == "main") {
			...
			for (var i = 0, len = menus.length; i < len; i++) {
				...
				element.append('<li value="' + i + '">' +
					'<div class="tabBtnCenter">' + menus[i].name + '&nbsp' + '&nbsp' +'</div>' + '<div style="color:#3181b6;">' + ' ' + '¦' + '</div>' + 
				'</li>');
				}
				else
				{
								element.append('<li value="' + i + '">' + '<div  style="color:#3181b6;">' + ' ' + '¦' + '</div>' +
					'<div class="tabBtnCenter">'  + menus[i].name  + '&nbsp' + '&nbsp' +'</div>' +  
				'</li>');
				}
            ...
            this.subMenuCounter = 0;
            for (var i = 0, len = menus.length; i < len; i++) {
                element.append('<li value="' + i + '"><div style="border-bottom:1px dashed #000000;width:198px">■ ' + menus[i].name + '</div></li>');
