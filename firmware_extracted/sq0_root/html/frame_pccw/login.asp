...
<div id="main_wrapper">
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
	  <td align="center" height="210" valign="bottom"> <table border="0" cellpadding="0" cellspacing="0" width="33%">
		  <tr>
			<td align="center" width="29%"> <img height="75" src="/images/logo.gif" width="70" alt=""> </td>
	...
	<tr>
      <td align="center" height="65"> <table border="0" cellpadding="0" cellspacing="0" class="tblcalss" height="65" width="40%" style="font-size:16px;"> 
		  <tr>
			...
			<td width="78%"> <input style="font-size:12px;font-family:Tahoma,Arial;" id="txt_Username" class="input_login" name="txt_Username" type="text" maxlength="32"> </td>
		  </tr>
		  <tr>
			<td class="whitebold" height="28" align="right" id="Password">Password</td>
			<td class="whitebold" height="28" align="center" >:</td>
			<td> <input style="font-size:12px;font-family:Tahoma,Arial;" id="txt_Password" class="input_login" name="txt_Password" type="password" maxlength="127" autocomplete="off">
				&nbsp;
