...
function IsIEBrower(num) {
    ...
    if(isIE){
        ...
        if(safariVersion <= num ){
        	if (Language == 'arabic')
        	{
        		alert("إصدار المتصفح لديك قديم (إصدارات Internet Explorer السادس والسابع والثامن غير مدعومة). يتوجب عليك ترقية المتصفح إلى الإصدار التاسع أو الإصدارات الأحدث.");
        	}
        	else{
...
function LoadFrame() {
	...
	if (Language == "arabic")
	{
		...
		document.getElementById('DivErrPage').dir = 'rtl';
		document.getElementById('contrluserclass').style.textAlign = "right";
		document.getElementById('contrlpwdclass').style.textAlign = "right";		
	...
	else
	{
	   ...
	   document.getElementById('account').innerHTML = 'Account';
		...
		document.getElementById('contrluserclass').style.textAlign = "left";
		document.getElementById('contrlpwdclass').style.textAlign = "left";			
		document.getElementById('txt_Username').focus();
	}
...
<div id="main_wrapper">
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
	  <td align="center" height="210" valign="bottom"> <table border="0" cellpadding="0" cellspacing="0" width="36%">
		  <tr>
			<td align="center" width="29%">
				<script language="JavaScript" type="text/javascript">
					if (CfgMode.toUpperCase() == 'STCATHEEB2')
					{
						document.write('<img height="84" src="images/logo_stcatheeb.gif" width="115" alt="">');
					}
					else
					{
						document.write('<img height="76" src="images/logo_stc.gif" width="188" alt="">');
					}
				</script>
			</td>
			...
			<td valign="bottom" width="50%"> <table border="0" cellpadding="0" cellspacing="0" class="text_copyright" width="100%">
				<tr>
							<td width="37%" nowrap>
								<a id="English" href="#" name="English" onClick="onChangeLanguage('english');" style="font-size:12px;font-family:Arial;">[English]</a></td>
							<td width="63%" nowrap>
								<a id="arabic" href="#" name="arabic" onClick="onChangeLanguage('arabic');" style="font-size:12px;font-family:Arial;">[العربية]</a></td>
						</tr>
			  </table></td>
		  </tr>
		</table></td>
	...
	<tr >
	  <td align="center" height="65">
		<div id="stc_dir">
      	<table border="0" cellpadding="0" cellspacing="0" class="tblcalss" height="65" width="45%" style="font-size:16px;"> 
		  <tr>
			<td class="whitebold" height="37" align="right" width="20%" id="account"></td>
			<td class="whitebold" height="37" align="center" width="2%">:</td>
			<td width="78%" id="contrluserclass"> <input style="font-size:12px;font-family:Tahoma,Arial;" id="txt_Username" class="input_login" name="txt_Username" type="text" maxlength="32"> </td>
		  </tr>
		  <tr>
			<td class="whitebold" height="28" align="right" id="Password"></td>
			<td class="whitebold" height="28" align="center" >:</td>
			<td id="contrlpwdclass"> <input style="font-size:12px;font-family:Tahoma,Arial;" id="txt_Password" class="input_login" name="txt_Password" type="password" maxlength="127" autocomplete="off">
&nbsp;
	...
	<tr>
	  <td class="info_text" height="25" id="footer" style="padding-right:90px"></td>
	</tr>
	<tr>
