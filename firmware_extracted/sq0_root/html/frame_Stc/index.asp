...
{
	document.write('<div id="headerLogoImg" style="background: url(../images/banner_logo_stcatheeb.gif) no-repeat center; height: 70px; width: 144px;"></div>');
}
else
{
	document.write('<div id="headerLogoImg" style="background: url(../images/banner_logo_stc.gif) no-repeat center; height: 70px; width: 144px;background-size:80%;"></div>');
}
</script>
