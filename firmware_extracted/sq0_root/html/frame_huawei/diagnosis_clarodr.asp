...
<body class="mainbody" onload="LoadFrame();">
    <div class=""><a id="redirectToLogin" style="color:#56B2F8;text-decoration: underline;margin-left: 1027px;"
            href="">loginPage</a></div>


    <div id="DCpingtitle_content" class="" style="font-size: 16px;margin-left: 116px;">
        Network connection interrupted, Please perform one-click diagnosis!
    </div>
    <div id="btndiagnoseDiv" class="btndiagnoseDivStyle">
        <input type="button" id="btndiagnose" class="bluebuttonBlueBgcss" style="font-size: 20px;"
            onclick="onbtndiagnose();" value="One-Click Diagnosis" />
    </div>
    ...
    <div id="resultID" style="display: none;">
        ...
        <div style="margin-left: 117px;">
            ...
            <div id="wandiagnostics">
                <div style="margin-top: 20px;">IPv4 Information</div>
                <table id="ipv4All" width="60%" border="0" cellpadding="0" cellspacing="1" class="tabal_bg"
                    style="table-layout:fixed; word-break:break-all">
                    <tr>
                        <td class="head_title" align="center">WAN Name</td>
                        <td class="head_title" align="center">Status</td>
                        <td class="head_title" align="center">IP Address</td>
                        <td class="head_title" align="center">Ping Test</td>
                        <td class="head_title" align="center">Diagnose Result</td>
                    </tr>
                </table>
                <div id="ipv6Info">
                    <div style="margin-top: 20px;">IPv6 Information</div>
