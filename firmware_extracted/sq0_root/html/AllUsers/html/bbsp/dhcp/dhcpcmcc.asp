...
function setLeaseCmcc(dhcpLease, flag)
{
    var i = 0;
    ...
    if ( flag == "main" )
    {
		...
		if(infinite)
		{
			setText('LanLeaseTime_text', dhcp_language['bbsp_infinitetime']);
		}
	    else
			setText('LanLeaseTime_text', dhcpLease / timeUnits);
    }
    else
    {
...
function setMainDhcp()
{
	with(document.forms[0])
	{
		...
		setLeaseCmcc(dhcpmain.leasetime, "main");
...
function AddSubmitParam(Form,type)
{
	 with (document.forms[0])
	 {
        ...
        Form.addParameter('z.DHCPLeaseTime',getValue('LanLeaseTime_select')*getValue('LanLeaseTime_text'));
	...
	var RequestFile = 'html/bbsp/dhcp/dhcpcmcc.asp';
	var urlpara;
...
function SetDHCPServerDisplay(value)
{
	...
	if ( value == 1 || value == '1' )
	{
        ...
        setDisable("LanLeaseTime_text",0);
	...
	{	    
        ...
        setDisable("LanLeaseTime_text",1);
...
function LanDhcpLeaseTimeOption(Value, Name)
{
	var ValueOption;
	ValueOption = '<option value=' + Value + '>';
	document.write(ValueOption);
	document.write(dhcp_language[Name]);			    
}
</script>
</head>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0"> 
	  ...
	  <tr>
		  ...
		  <td width="75%" class="table_right"> <span id="MainLeasedShowTime"></span>
		    <input type='text' name='LanLeaseTime_text' id='LanLeaseTime_text' maxlength='15' size='15'> 
			<select id='LanLeaseTime_select' name='LanLeaseTime_select' size='1' style="width: 65px" onMousedown="OnLeaseChange();""> 
			    <option value='1'><script>document.write(dhcp_language['bbsp_second']);</script>
				<option value='60'><script>document.write(dhcp_language['bbsp_minute']);</script>
				<option value='3600'><script>document.write(dhcp_language['bbsp_hour']);</script>
				<option value='86400'><script>document.write(dhcp_language['bbsp_day']);</script>
				<option value='604800'><script>document.write(dhcp_language['bbsp_week']);</script>
