...
function SubmitForm()
{
	...
	if(TR181FirewallFT == 1 && COMMONV5FirewallFT == 1)	
	{
		...
		else if(v5firewallLevel == "Standard")
		{
			...
			Form.addParameter('x.AdvancedLevel', AdvancedLevel);
			Form.addParameter('x.X_HW_Token', getValue('onttoken'));
			Form.setAction('set.cgi?x=InternetGatewayDevice.X_HW_Security.Firewall'+ '&RequestFile=html/bbsp/firewalllevel/firewalllevel.asp');
			Form.submit();
		}
...
<form id="FirewallLevelForm" name="FirewallLevelForm">
	<table border="0" cellpadding="0" cellspacing="1"  width="100%" class="tabal_noborder_bg">
		...
		<li id="SecurityLevel"  RealType="DropDownList" DescRef="bbsp_setlevelmh"   RemarkRef="Empty"   ErrorMsgRef="Empty"  Require="FALSE"   BindField="Empty"  InitValue="[{TextRef:'Disable',Value:'Disable'},{TextRef:'High',Value:'High'},{TextRef:'Medium',Value:'Medium'},{TextRef:'Low',Value:'Low'},{TextRef:'Custom',Value:'Custom'}]"/>
		...
		<li id="COMMONV5SecurityLevel"  RealType="DropDownList" DescRef="bbsp_setlevelmh"   RemarkRef="Empty"   ErrorMsgRef="Empty"  Require="FALSE"   BindField="Empty"  InitValue="[{TextRef:'Disable',Value:'Disable'},{TextRef:'Standard',Value:'Standard'}]"/>
		<li id="COMMONV5SecurityLevelNOS2"  RealType="DropDownList" DescRef="bbsp_setlevelmh"   RemarkRef="Empty"   ErrorMsgRef="Empty"  Require="FALSE"   BindField="Empty"  InitValue="[{TextRef:'High',Value:'High'},{TextRef:'Medium',Value:'Medium'},{TextRef:'Low',Value:'Low'}]"/>
