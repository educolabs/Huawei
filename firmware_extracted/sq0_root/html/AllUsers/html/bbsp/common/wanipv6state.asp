...
var IPv6PrefixList  =  <%HW_WEB_GetSpecParaArryByDomain(HW_WEB_GetIPv6WanPrefix, InternetGatewayDevice.WANDevice.{i}.X_HW_ShowInterface.{i}.IPv6Prefix.{i},Origin|Prefix|PreferredTime|ValidTime|ValidTimeRemaining,IPv6PrefixInfo);%>;
