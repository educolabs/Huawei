...
var TemplatesListArray = <%HW_WEB_GetParaArryByDomain(InternetGatewayDevice.X_HW_Security.ParentalCtrl.Templates.{i},Name|UrlFilterPolicy|UrlFilterRight|StartDate|EndDate|DurationPolicy|DurationRight,TemplatesListClass);%>;
