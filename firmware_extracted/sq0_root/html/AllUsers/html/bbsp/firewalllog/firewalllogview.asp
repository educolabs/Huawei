...
HWCreatePageHeadInfo("firewalllog", GetDescFormArrayById(firewalllogviewLgeDes, "s0b0e"), GetDescFormArrayById(firewalllogviewLgeDes, titleRef), false);
</script> 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabal_head"> 
  <tr> 
    <td class="width_per100 bold_astro" BindText="s0b0f"></td> 
  </tr> 
</table> 
