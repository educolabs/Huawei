...
function OpticInfo(domain,transOpticPower,revOpticPower,voltage,temperature,bias)
{
    this.Domain = domain;
...
var OpticInfoList = <%HW_WEB_GetParaArryByDomain(InternetGatewayDevice.X_HW_DEBUG.AMP.Optic,TxPower|RxPower|Voltage|Temperature|Bias, OpticInfo);%>; 
