...
var WanList = <%HW_WEB_GetParaArryByDomain(InternetGatewayDevice.WANDevice.{i}.WANConnectionDevice.{i}.WANPPPConnection.{i},ConnectionType|X_HW_SERVICELIST|X_HW_ExServiceList|Username|Password,WanPPP);%>;
