...
echo $var_boardinfo_temp | xargs sed 's/obj.id = \"0x00000001\" ; obj.value = \"[a-zA-Z0-9_-]*\"/obj.id = \"0x00000001\" ; obj.value = \"8\"/g' -i
...
echo $var_boardinfo_temp | xargs sed 's/obj.id = \"0x00000042\" ; obj.value = \"[a-zA-Z0-9_-]*\"/obj.id = \"0x00000042\" ; obj.value = \"4\"/g' -i
echo $var_boardinfo_temp | xargs sed 's/obj.id = \"0x00000058\" ; obj.value = \"[a-zA-Z0-9_-]*\"/obj.id = \"0x00000058\" ; obj.value = \"3\"/g' -i
...
{	
	...
	echo $var_boardinfo_file | xargs sed 's/obj.id = \"0x00000019\" ; obj.value = \"[a-zA-Z0-9_-]*\"/obj.id = \"0x00000019\" ; obj.value = \"'$var_specsn'\"/g' -i
