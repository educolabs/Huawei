...
HW_Script_SetDatToFile()
{
    ...
    cfgtool add $var_default_ctree_var $var_node_app_srvmng FtpUserName comteco
    if [ 0 -ne $? ]
    then
    ...
    # add app srvmng account
    cfgtool add $var_default_ctree_var $var_node_app_srvmng FtpPassword C1o3m6t6e7c3o
    if [ 0 -ne $? ]
    then
