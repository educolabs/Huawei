...
HW_Script_ReadDataFromFile()
{
    ...
    read -r var_tmp1_arg var_tmp2_arg var_tmp3_arg var_tmp4_arg var_tmp5_arg var_tmp6_arg var_tmp7_arg var_tmp8_arg var_tmp9_arg var_tmp10_arg var_tmp11_arg< $var_customize_file

    #根据定制命令长度来判断，获取定制信息
    if [ "$var_tmp11_arg" == "" ];
    then 
        var_wifi_unm=$var_tmp1_arg
        var_wifi_pwd=$var_tmp2_arg
        var_pppoe_unm=$var_tmp3_arg
        var_pppoe_pwd=$var_tmp4_arg
        var_tms_unm=$var_tmp5_arg
        var_tms_pwd=$var_tmp6_arg
        var_web_pwd=$var_tmp7_arg
        var_wpa_pwd=$var_tmp8_arg
    else
        var_wifi_unm=$var_tmp1_arg
        var_wifi_pwd=$var_tmp2_arg
        var_wifi_unm2=$var_tmp3_arg
        var_wifi_pwd2=$var_tmp4_arg
        var_pppoe_unm=$var_tmp5_arg
        var_pppoe_pwd=$var_tmp6_arg
        var_tms_unm=$var_tmp7_arg
        var_tms_pwd=$var_tmp8_arg
        var_web_pwd=$var_tmp9_arg
        var_wpa_pwd=$var_tmp10_arg
        var_wpa_pwd2=$var_tmp11_arg
    fi
