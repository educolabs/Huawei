...
HW_Script_ReadDataFromFile()
{
    ...
    then 
        ...
        var_web_pwd=$var_tmp3_arg
        var_cli_pwd=$var_tmp4_arg
        var_wpa_pwd=$var_tmp5_arg
    else
        var_wifi_unm=$var_tmp1_arg
        var_wifi_pwd=$var_tmp2_arg
        var_wifi_unm2=$var_tmp3_arg
        var_wifi_pwd2=$var_tmp4_arg
        var_web_pwd=$var_tmp5_arg
        var_cli_pwd=$var_tmp6_arg
        var_wpa_pwd=$var_tmp7_arg
        var_wpa_pwd2=$var_tmp8_arg
    fi
...
{	
    ...
    cfgtool set $var_default_ctree_var $var_cli_node Userpassword $var_cli_pwd
    if [ 0 -ne $? ]
    then
