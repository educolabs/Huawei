...
then
    echo $var_boardinfo_temp | xargs sed 's/obj.id = \"0x00000061\" ; obj.value = \"[a-zA-Z0-9_-]*\"/obj.id = \"0x00000061\" ; obj.value = \"1\"/g' -i
fi
...
echo $var_boardinfo_temp | xargs sed 's/obj.id = \"0x00000042\" ; obj.value = \"[a-zA-Z0-9_-]*\"/obj.id = \"0x00000042\" ; obj.value = \"3\"/g' -i
echo $var_boardinfo_temp | xargs sed 's/obj.id = \"0x00000059\" ; obj.value = \"[a-zA-Z0-9_-]*\"/obj.id = \"0x00000059\" ; obj.value = \"8\"/g' -i
