...
HW_Script_SetDatToFile()
{
	...
	var_node_webuser_password=InternetGatewayDevice.UserInterface.X_HW_WebUserInfo.X_HW_WebUserInfoInstance.1
	...
	if [ -n "$var_web_pwd" ]; then
		HW_Script_Cfgtool_Set $var_default_ctree $var_node_webuser_password "Password" $var_web_pwd
	fi
