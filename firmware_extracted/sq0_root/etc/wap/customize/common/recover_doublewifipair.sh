...
HW_Script_ReadDataFromFile()
{
	...
	then
		read -r var_ssid1 var_wpa1 var_ssid2 var_wpa2 pairToken < $var_customize_file
		if [ 0 -ne $? ]
		then
...
HW_Script_SetDatToFile()
{
	...
	var_node_pair=InternetGatewayDevice.X_HW_APTokenService
	...
	HW_Script_Cfgtool_Set $var_default_ctree $var_node_pair "PairToken" $var_pairToken
