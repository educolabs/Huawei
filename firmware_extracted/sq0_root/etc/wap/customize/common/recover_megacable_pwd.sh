...
var_gCfgWord=""
type_word_v5="COMMON COMMON2 EUCOMMON EUCOMMON2 NACOMMON NACOMMON2 COMMONEBG COMMONEBG2 EUCOMMONEBG EUCOMMONEBG2 NACOMMONEBG NACOMMONEBG2 CLOSETELNET CLOSETELNETEBG CLOSETELNETEBG2 CHINA CHINAEBG MEGACABLE2"
...
HW_Script_SetDatToFile()
{
	...
	HW_Script_Cfgtool_Set $var_default_ctree $var_node_web_user "Password" $var_web_pwd
